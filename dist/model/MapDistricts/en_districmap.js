...
const en_districmap = new mongoose_1.Schema({
    districtname: { type: String, required: true },
    districtkey: { type: String, required: true, index: true },
    constituencies: { type: [ConstituencySchema], default: [] },
    private: { type: Boolean, default: false }
});
const DistrictModel = mongoose_1.default.model('en_districmap', en_districmap);
exports.default = DistrictModel;
//# sourceMappingURL=en_districmap.js.map